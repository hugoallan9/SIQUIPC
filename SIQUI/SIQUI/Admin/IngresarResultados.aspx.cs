    ...
    public partial class IngresarResultados : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["currentUser"] != null)
            {
                ...
                {
                    quiniela = new Quiniela("Master",Convert.ToString(((Usuario)Session["currentUser"]).Codigo),((Torneo)Session["torneoActual"]).idTorneo);
                }
            }

            if (quiniela.existeQuiniela("Master", Convert.ToString(((Usuario)Session["currentUser"]).nombreUsuario), ((Torneo)Session["torneoActual"]).idTorneo))
            {
                Response.Redirect("/Admin/EditarResultados.aspx?" + ((Torneo)Session["torneoActual"]).idTorneo);
            }
            ...
            if (!IsPostBack)
            {
                ...
                quiniela = new Quiniela("Master", Convert.ToString(((Usuario)Session["currentUser"]).Codigo), ((Torneo)Session["torneoActual"]).idTorneo); Session["quiniela"] = quiniela;
