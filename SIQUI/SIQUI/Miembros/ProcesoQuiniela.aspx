<%@ Page Title="Proceso de Creación" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProcesoQuiniela.aspx.cs" Inherits="SIQUI.Miembros.ProcesoQuiniela" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">
        <asp:Button ID="grabarBt" runat="server" Text="Guardar Quiniela" OnClick="grabarBt_Click" />
    </div>
